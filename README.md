...
Update Zotero items with metadata from bibliographic databases: CrossRef.org, DBLP.org, OpenAlex.org, and arXiv.org. If you want to add more search engines, pull requests are welcome, look at `searchCrossRef()` in `metadataSearchPlugin.js` as an example.
